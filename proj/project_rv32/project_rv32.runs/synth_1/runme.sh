...
HD_PWD='C:/Users/Evan/Documents/HDL_Projects/RV32IM/proj/project_rv32/project_rv32.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fetch_pipe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fetch_pipe.tcl
